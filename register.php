...
<head>
    ...
    function pop_up_email() {
        Swal.fire({
            icon: 'error',
            title: 'Oops',
            text: 'The Email Addess that enter had being Registered.',
            showCancelButton: true,
...
<body>
    ...
    <div class="form_container">
        <form action="" method="POST" class="login">
            <p class="login_word" style="font-size: 2rem; font-weight: 100;">User Register</p>
            ...
            <p class="login-register_exchange">For Company Register: &nbsp<a class="account_a" href="register_company.php">Click Here</a></p>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($password == $confirmpass){
            ...
            if(mysqli_num_rows($result)==1){
                ...
                $id= 'U'.sprintf("%'03d", $X+1);

                $sql = "INSERT INTO `user`(`UserID`, `Name`, `Email`, `Password`, `Role`) VALUES ('$id','$name','$email','$password','User')";
                $result = mysqli_query($con, $sql);
